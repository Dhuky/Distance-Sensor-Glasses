...
o	Caminho Livre: Silêncio total para distâncias acima de 1 metro.
o	Aproximação: Bips que aceleram conforme o obstáculo se aproxima (entre 20cm e 100cm).
o	Alerta Crítico: Som contínuo para obstáculos a menos de 20cm.
...
💻 Instalação e Uso
1.	Certifique-se de ter a Arduino IDE instalada.
